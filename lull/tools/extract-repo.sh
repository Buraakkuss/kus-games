...
# Kullanim: bash tools/extract-repo.sh ~/lull-app
set -e
...
mkdir -p "$DEST/docs"
cp -r "$SRC/../docs/lull/"* "$DEST/docs/" 2>/dev/null || true
...
echo "Hazir: $DEST"
echo "Simdi GitHub'da 'lull-app' deposunu ac ve:"
echo "  cd $DEST"
echo "  git remote add origin https://github.com/<kullanici>/lull-app.git"
