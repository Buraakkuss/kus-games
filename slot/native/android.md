...
```bash
keytool -genkey -v -keystore slot-release.jks -keyalg RSA -keysize 2048 \
        -validity 10000 -alias slot
```
> `slot-release.jks` dosyasını ve parolasını yedekle. Kaybedersen bu uygulamayı
