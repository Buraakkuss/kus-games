...
silip yeniden olusturdugunda tekrar calistir.

> Bulutta derleme: depo kokunde `.github/workflows/android.yml` var. Her pushta
> GitHub Actions ayni scripti calistirip AAB ve debug APK uretir - kendi
> bilgisayarina Android Studio kurman gerekmez. **Java 21 zorunlu**
> (Capacitor 7; JDK 17 ile "invalid source release: 21" hatasi gelir).
...
```bash
keytool -genkey -v -keystore orbita-release.jks -keyalg RSA -keysize 2048 \
        -validity 10000 -alias orbita
```
> `orbita-release.jks` dosyasını ve parolasını yedekle. Kaybedersen bu uygulamayı
