...
```xml
<string name="app_name">Seher</string>
<string name="title_activity_main">Seher</string>
<string name="package_name">com.kusgrup.seher</string>
<string name="custom_url_scheme">com.kusgrup.seher</string>
```
> Cihazın ana ekranında görünen ad `app_name`. Play mağaza adı ("Seher: Namaz Vakti ve Kıble")
...
```bash
keytool -genkey -v -keystore seher-release.jks -keyalg RSA -keysize 2048 \
        -validity 10000 -alias seher
```
> `seher-release.jks` dosyasını ve parolasını yedekle. Kaybedersen bu uygulamayı
