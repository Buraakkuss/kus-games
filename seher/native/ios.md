...
- **Display Name:** `Seher`
- **Bundle Identifier:** `com.kusgrup.seher`
...
<string>Your choice here only affects how relevant the ads in Seher are. The game itself works exactly the same either way.</string>
...
| Reddedilme: kumar şüphesi | İsim yüzünden olur. App Review notundaki kumar açıklamasını gönderiye eklediğinden emin ol (`store/app-store.md`) |
